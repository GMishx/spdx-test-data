...
License.
   ...
   1.13 "Patent Claims" means any patent claim(s), now owned
...
except as disclosed pursuant to Section 3.4(a) above, Contributor
...
(such as a relevant directory) where a user would be most likely to
...
intellectual property claims relating to the Covered Code) incurred by
...
the obligation of Section 3.2. The notice must be conspicuously
...
Code.
   ...
   4. Inability to Comply Due to Statute or Regulation. If it
is impossible for You to comply with any of the terms of this License
...
understand it.
   ...
   5. Application of this License. This License
...
and fail to cure such breach within a reasonable time after becoming
...
file such action is referred to as "Participant") alleging that: o (a)
...
License.
   ...
   12. RESPONSIBILITY FOR CLAIMS. As between Initial
...
admission of liability.
   ...
   13. MULTIPLE-LICENSED CODE. Initial
...
use, or distribute the Covered Code for any purpose. EXHIBIT A The
SNIA Public License.
