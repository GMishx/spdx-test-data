...
The Netscape Public
License Version 1.1 ("NPL") consists of the Mozilla Public License
Version 1.1 with the following Amendments, including Exhibit
A-Netscape Public License. Files identified with "Exhibit A-Netscape
Public License" are governed by the Netscape Public License Version
1.1.
...
Public License -- Amendments shall apply to the Mozilla Communicator
...
which are controlled by Netscape but which are not licensed for use
under this License.

   III. Netscape and logo.

   This License does
not grant any rights to use the trademarks "Netscape", the "Netscape N
and horizon" logo or the "Netscape lighthouse" logo, "Netcenter",
"Gecko", "Java" or "JavaScript", "Smart Browsing" even if such marks
are included in the Original Code or Modifications.

   IV. Inability
to Comply Due to Contractual Obligation.

   Prior to licensing the
Original Code under this License, Netscape has licensed third party
code for use in Netscape's Branded Code. To the extent that Netscape
is limited contractually from making such third party code available
under this License, Netscape may choose to reintegrate such code into
...
"Modifications" under this License.
   ...
   V. Use of Modifications and
Covered Code by Initial Developer.

      V.1. In General.

      The
obligations of Section 3 apply to Netscape, except to the extent
...
License, and may license such additional products on different terms
...
Branded Code, including Modifications incorporated therein, without
such Netscape Branded Code becoming subject to the terms of this
License, and may license such Netscape Branded Code on different terms
from those contained in this License.
...
to the Netscape Public License Version 1.1 (the "License"); you may
...
code, released March 31, 1998.

The Initial Developer of the Original
Code is Netscape Communications Corporation. Portions created by
Netscape are Copyright (C) 1998-1999 Netscape Communications
...
(or portions thereof); and 2) the combination of Modifications made by
...
notice in Exhibit A in each file of the Source Code. If it is not
...
created under this License.
      ...
      If You
create or use a modified version of this License (which you may only
...
indirectly infringes any patent, then any rights granted to You by
...
determining the amount or value of any payment or license.
      ...
      8.4.
In the event of termination under Sections 8.1 or 8.2 above, all end
...
by the Initial Developer in the file described in Exhibit A. Exhibit A
...
the text of the notices in the Source Code files of the Original Code.
