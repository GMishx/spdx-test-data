...
"Reserved Font Name" refers to the
Font Software name as seen by users and any other names as specified
after the copyright statement.

"Standard Version" refers to the
collection of Font Software components as distributed by the Copyright
Holder.
...
"Author" refers
to any designer, engineer, programmer, technical writer or other
...
differentiate the font from others.
   ...
   4) The name(s) of the
Copyright Holder or the Author(s) of the Font Software shall not be
