...
Contributor's Contribution.
      ...
      1.3. "Contribution" means Covered
...
notice described in Exhibit B to the Covered Software; or
...
a Secondary License.
      ...
      1.6. "Executable Form" means any form of
the work other than Source Code Form.

      1.7. "Larger Work" means
a work that combines Covered Software with other material, in a
separate file or files, that is not Covered Software.

      1.8.
"License" means this document.

      1.9. "Licensable" means having
the right to grant, to the maximum extent possible, whether at the
time of the initial grant or subsequently, any and all of the rights
conveyed by this License.

      1.10. "Modifications" means any of
the following:
...
Covered Software; or
         ...
         (b) any new file in Source Code Form
that contains any Covered Software.

      1.11. "Patent Claims" of a
Contributor means any patent claim(s), including without limitation,
...
Contributor Version.
      ...
      1.12. "Secondary License" means either the
GNU General Public License, Version 2.0, the GNU Lesser General Public
License, Version 2.1, the GNU Affero General Public License, Version
3.0, or any later versions of those licenses.

      1.13. "Source
Code Form" means the form of the work preferred for making
modifications.
...
as part of a Larger Work; and
         ...
         (b) under Patent Claims of
such Contributor to make, use, sell, offer for sale, have made,
...
Contributor Version.
      ...
      The licenses
granted in Section 2.1 with respect to any Contribution become
...
rights granted under this License. No additional rights or licenses
will be implied from the distribution or licensing of Covered Software
under this License. Notwithstanding Section 2.1(b) above, no patent
license is granted by a Contributor:

         (a) for any code that a
Contributor has removed from Covered Software; or
...
Representation
      ...
      Each Contributor represents that the Contributor
...
to limit any rights You have under applicable copyright doctrines of
...
Application of Additional Terms
      ...
      You may choose to offer, and to
...
any entity by asserting a patent infringement claim (excluding
...
terminate.
      ...
      5.3. In the event of termination under Sections 5.1
or 5.2 above, all end user license agreements (excluding distributors
and resellers) which have been validly granted by You or Your
...
10. Versions of the License
      ...
      Mozilla
Foundation is the license steward. Except as provided in Section 10.3,
...
Exhibit B - "Incompatible With Secondary Licenses"
Notice
