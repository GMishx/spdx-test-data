...
Source Code notice required byExhibit A.
...
described in the Source Code notice required byExhibit A as Original
...
all of the Covered Code due to statute or regulation then You must:
...
parties to distribute responsibility on an equitable
basis.
...
lighthouse logo, even if such marks are included in the Original
Code.
...
Use of Modifications and Covered Code by Initial Developer.
   ...
   V.1.
In General. The obligations of Section 3 apply to Netscape, except to
the extent specified in this Amendment, Section V.2 and V.3.

   V.2.
Other Products. Netscape may include Covered Code in products other
...
from those contained in this License. V.3. Alternative Licensing.
...
The
Original Code is Mozilla Communicator client code, released March 31,
1998.

The Initial Developer of the Original Code is Netscape
Communications Corporation. Portions created by Netscape are Copyright
(C) 1998 Netscape Communications Corporation. All Rights
Reserved.
