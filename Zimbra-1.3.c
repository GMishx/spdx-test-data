...
under copyright in Section 1.1, no rights, licenses or forbearances
are granted or may arise in relation to this Agreement whether
expressly, by implication, exhaustion, estoppel or otherwise. All
rights, including all intellectual property rights, that are not
...
WITHOUT WARRANTY OF ANY KIND. VMWARE MAKES NO WARRANTIES, WHETHER
EXPRESS, IMPLIED, OR STATUTORY REGARDING OR RELATING TO THE SOFTWARE.
SPECIFICALLY, VMWARE DOES NOT WARRANT THAT THE SOFTWARE WILL BE ERROR
FREE OR WILL PERFORM IN AN UNINTERRUPTED MANNER. TO THE GREATEST
EXTENT ALLOWED BY LAW, VMWARE SPECIFICALLY DISCLAIMS ALL IMPLIED
WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE (EVEN
IF VMWARE HAD BEEN INFORMED OF SUCH PURPOSE), AND NONINFRINGEMENT WITH
...
THE USE OF THE FOREGOING.
   ...
   IN NO
EVENT WILL VMWARE BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL,
...
EVEN IF VMWARE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
...
VMware may terminate this Agreement.
...
to VMware at law or equity or under this Agreement.
...
limiting VMware's liability (Sections 4 and 5), Termination (Section
...
Agreement. All disputes arising out of this Agreement involving VMware
...
consolidation, without the prior written consent of VMware, and any
