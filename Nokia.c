...
includes Affiliates of such entity. 2. SOURCE CODE LICENSE.
...
to third party intellectual property claims:
      ...
      a) under
copyrights Licensable by Nokia to use, reproduce, modify, display,
...
the Original Software (or portions thereof).
      ...
      c) The licenses
granted in this Section 2.1(a) and (b) are effective on the date Nokia
first distributes Original Software under the terms of this License.


     d) Notwithstanding Section 2.1(b) above, no patent license is
granted: 1) for code that You delete from the Original Software; 2)
separate from the Original Software; or 3) for infringements caused
by: i) the modification of the Original Software or ii) the
...
necessarily infringed by the making, using, or selling of
...
Covered Software may be distributed only under the terms of this
...
the Source Code You distribute. You may not offer or impose any terms
...
the Covered Software. 4. INABILITY TO COMPLY DUE TO STATUTE OR
REGULATION.
...
notice in Exhibit A and to related Covered Software. 6. VERSIONS OF
THE LICENSE.
...
actions) against Nokia or a Contributor (Nokia or Contributor against
...
determining the amount or value of any payment or license.
   ...
   8.4 In
the event of termination under Sections 8.1 or 8.2 above, all end user
...
termination shall survive termination. 9. LIMITATION OF
LIABILITY.
...
according to its terms. 11. RESPONSIBILITY FOR CLAIMS.
