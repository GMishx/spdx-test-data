...
TO THIS PUBLICATION OR THE UNICODE WEBSITE.
   ...
   D. Waiver of Damages.
In no event shall Unicode or its licensors be liable for any special,
...
information or its derivatives.
   ...
   E. Trademarks & Logos.
      ...
      1.
The Unicode Word Mark and the Unicode Logo are trademarks of Unicode,
...
Trademark Usage Policy ("Trademark Policy") are incorporated herein by
reference and you agree to abide by the provisions of the Trademark
Policy, which may be changed from time to time in the sole discretion
of Unicode, Inc.

      3. All third party trademarks referenced
...
or use of the information herein, except for those based on Unicode's
net income.

      4. Severability. If any provision of this Agreement
is declared invalid or unenforceable, the remaining provisions of this
