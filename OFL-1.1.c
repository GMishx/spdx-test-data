...
with
Reserved Font Name <Reserved Font Name>. This Font Software is
licensed under the SIL Open Font License, Version 1.1.

This license
is copied below, and is also available with a FAQ at:
http://scripts.sil.org/OFL SIL OPEN FONT LICENSE
...
to stimulate worldwide development of collaborative font projects, to
...
any document created using the fonts or their
derivatives.
...
the collection of Font Software components as distributed by the
Copyright Holder(s).

"Modified Version" refers to any derivative made
by adding to, deleting, or substituting — in part or in whole —
...
Original or Modified Versions, may be sold by itself.
   ...
   2) Original
or Modified Versions of the Font Software may be bundled,
