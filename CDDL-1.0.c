...
and You want to create a new license for Your Original Software, You
may create and use a modified version of this License if You: (a)
...
written agreement with Participant.
      ...
      6.3. In the event of
termination under Sections 6.1 or 6.2 above, all end user licenses
