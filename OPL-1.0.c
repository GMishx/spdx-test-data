...
governed by the terms of this License.
      ...
      1.8. "License" means
this document and the corresponding addendum described in section 6.4
below.
...
Developer hereby grants You a worldwide, royalty-free, non-exclusive
...
Original Code (or portions thereof) and not to any greater extent that
...
number and shall be submitted to opensource.org for certification.
...
License published by Initial Developer. No one other than Initial
Developer has the right to modify the terms applicable to Covered Code
created under this License.

      6.3. Derivative Works. If you
create or use a modified version of this License, except in
association with the required Developer Specific License described in
section 6.4, (which you may only do in order to apply it to code which
is not already Covered Code governed by this License), you must (a)
rename Your license so that the phrases ``Open'', ``OpenPL'', ``OPL''
...
license contains terms which differ from the Open Public License.
...
Required Additional Developer Specific License
      ...
      This license is
a union of the following two parts that should be found as text files
...
file OPL_1_0.TXT, stating the general licensing policy of the
software.

      In case of conflicting dispositions in the parts of
this license, the terms of the lower-numbered part will always be
...
termination of this License shall survive.
      ...
      8.2. Termination
Upon Litigation. If You initiate litigation by asserting a patent
...
COVERED CODE, OR ANY SUPPLIER OF ANY OF SUCH PARTIES, BE LIABLE TO YOU
