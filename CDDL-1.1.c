...
means the individual or entity that first makes Original Software
...
Original Software or previous Modification; or
         ...
         C. Any new
file that is contributed or otherwise made available under the terms
of this License.

      1.10. "Original Software" means the Source
Code and Executable form of computer software code that is originally
...
the Original Software (or portions thereof).
         ...
         (c) The
licenses granted in Sections 2.1(a) and (b) are effective on the date
...
using, or selling of Modifications made by that Contributor either
...
in Sections 2.2(a) and 2.2(b) are effective on the date Contributor
first distributes or otherwise makes the Modifications available to a
third party.
...
Obligations.
      ...
      Any
Covered Software that You distribute or otherwise make available in
...
conveyed by this License.
      ...
      You
must include a notice in each of Your Modifications that identifies
...
3.4. Application of Additional Terms.
      ...
      You may not offer or
impose any terms on any Covered Software in Source Code form that
...
fee for, warranty, support, indemnity or liability obligations to one
or more recipients of Covered Software. However, you may do so only on
...
and (b) otherwise make it clear that the license contains terms which
...
of becoming aware of the breach. Provisions which, by their nature,
...
written agreement with Participant.
      ...
      6.3. If You assert a patent
infringement claim against Participant alleging that the Participant
